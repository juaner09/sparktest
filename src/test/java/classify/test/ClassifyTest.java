...
public class ClassifyTest {
    public static void main(String[] args) {
        ...
        System.out.println(nb_model.predict(v));
        System.out.println(nb_model.predictProbabilities(v));

        //支持向量机
        int numIterations = 100;//迭代次数
        final SVMModel svm_model = SVMWithSGD.train(training.rdd(), numIterations);
